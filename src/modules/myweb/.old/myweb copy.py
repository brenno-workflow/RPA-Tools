...
class MyWeb:
    ...
    def element(self, element, type, action, subaction = None, condition = None):
        ...
        Args:
            ...
            action (str): A ação que será realizada ['FIND', 'CLICK', 'TEXT', 'SEND_KEYS', 'CHECKBOX', 'DROPDOWN'].
            subaction (str / opcional): A subação que irá realizar ['INDEX', 'VALUE', 'TEXT', 'LIST', 'SEND_KEYS', 'GET_ATTRIBUTE', 'IS DISPLAYED'].
                obs.: Por padrão, será 'None'.
            condition (str, int / opcional): A condição para realizar a subação.
                obs.: Por padrão, será 'None'.
        """
                ...
                if self.resultado:
                    ...
                    # ---------------------- CLICK ----------------------
                        ...
                        if status_click:
                            ...
                            self.status = False
                            mensagem = '"Click" não está disponivel.'
                            print(mensagem)
