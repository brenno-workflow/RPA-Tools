        ...
        try:
            ...
            if status_banner['status']:
                ...
                if status_click_close['status']:
                    ...
                    status_banner_hidden = self.my_web.element(
                        self.input_banner_hidden, 'xpath', 'find')

                    if status_banner_hidden['status']:
                        self.status = True
                        ...
                        self.status = False
                        #mensagem = f'Falha ao buscar o status do attributo: "{self.attribute_aria_hidden}"'
                        mensagem = f'Falha - Banner de notificações não foi fechado.'
                        print(mensagem)
