...
class FsistLogin():
    ...
    def __init__(self, 
                 ...
                 param_fsist, param_true,
                 input_user, input_password, button_login, button_entrar):
    ...
    def fsist_login(self):
        ...
        try:
            ...
            filter_id = [self.param_fsist, self.param_true]
            ...
            # Retorna a lista de resultados
                ...
                if status_open_url['status']:
                    status_entrar = self.my_web.element(self.button_entrar, 'xpath', 'find', 'click')
                    ...
                    if status_entrar['status']:
                        ...
                        if status_type_login['status']:
                            ...
                            if status_type_password['status']:
                                status_entrar = self.my_web.element(self.button_login, 'id', 'find', 'click')
