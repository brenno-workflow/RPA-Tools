...
class FsistLimpar:
    ...
    def __init__(self, 
                 user, host, database, module_fsist, type_subcontrole, name_download, 
    ...
    def fsist_limpar_download(self):
        ...
        try:
            ...
            if status_mysql_controle['status']:
                ...
                status_limpar_pasta = self.my_folder.limpar_pasta(path_download)
