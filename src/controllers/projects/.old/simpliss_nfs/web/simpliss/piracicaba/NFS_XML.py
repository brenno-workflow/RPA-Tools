...
class NFSXml():
    ...
    def sid_pesquisar(self):
        ...
        try:
            ...
            status_search_bar = self.my_web.element(self.input_search, 'xpath', 'CLICK', 'send_keys', file_name)

            if status_search_bar['status']:

                # Digitar enter
                status_key_enter = self.my_web.element(self.input_search, 'xpath', 'send_keys', None, Keys.ENTER)
