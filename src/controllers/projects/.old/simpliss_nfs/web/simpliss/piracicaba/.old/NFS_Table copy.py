        ...
        try:
            ...
            if status_current_url['status']:
                ...
                if status_new_tab['status']:
                    ...
                    status_switch_tab = self.my_web.browser('switch_to', 'window', -1)

                    if status_switch_tab['status']:

                        status_new_tab_url = self.my_web.browser('get', None, url)

                        if status_new_tab_url['status']:
                            self.status = True
                            print(self.sucesso)
                        ...
                        self.status = False
                        mensagem = "Falha ao mudar de aba no navegador"

                else:
                    self.status = False
                    mensagem = "Falha ao criar uma nova aba no navegador"
    ...
    def nfs_close_table(self):
        ...
        try:
            ...
            if status_close_tab['status']:
                ...
                status_switch_tab = self.my_web.browser('switch_to', 'window', 0)
