...
class NFSNota():
            ...
            if status_index_table['status']:
                ...
                #while True:
                    ...
                    if status_table_rows['status']:
                        ...
                        table_identificacion = {'id': 'tb_Pesquisa'}

                        # Criar tabela virtual
                        status_table_new = self.my_pandas.table(html_content, 'element', 'create_table', 'html_parser', table_identificacion)
                        ...
                        if status_table_new['status']:
                            ...
                            status_table_filter = self.my_pandas.table(table_new, 'element', 'read', 'query', filter)
                            ...
                            if status_table_filter['status']:
                                ...
                                self.my_logger.log_info(f'table_filter: {table_filter}')
    ...
    # Verificar e cancelar notas
    def nfs_canceladas(self, element):
