...
class SIDVerificar():
    ...
    def sid_verificar(self):
        ...
        try:
            ...
            status_conteudo_anexos = self.my_web.browser('execute_script', None, self.js_sid_cliente_anexos_table)

            if status_conteudo_anexos['status']:

                self.my_logger.log_info('------------------------------')
                self.my_logger.log_info(status_conteudo_anexos['status'])
                ...
                self.my_logger.log_info('------------------------------')
                self.my_logger.log_info(table_files)
