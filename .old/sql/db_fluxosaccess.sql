...
create table if not exists db_fluxosaccess (
...
drop table db_fluxosaccess;

insert into db_fluxosaccess values 
...
INSERT INTO db_fluxosaccess (name, db_sites_id) VALUES ('sid_cliente_workflow', 5);

update db_fluxosaccess set diretorio = 'Desktop' where id = 1;

alter table db_fluxosaccess add foreign key (id_subprocess) references subprocess(id);

select * from db_fluxosaccess;