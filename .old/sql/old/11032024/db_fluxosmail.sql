...
(default, 'mail', 15, 1, 1, default, default),
(default, 'mail_repositorio', 16, 1, 1, default, default),
(default, 'mail_sid_cliente_anexos_sucesso', 17, 3, 1, default, default),
(default, 'mail_sid_cliente_anexos_falha', 18, 3, 1, default, default),
(default, 'mail_sid_cliente_anexos_erro', 19, 3, 1, default, default);
