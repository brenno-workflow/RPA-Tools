...
(default, 'sid', '//192.168.125.16//Dados//SID', default, default),
(default, 'sid_cliente', '//192.168.125.16//Dados//SID//Cliente', default, default),
(default, 'sid_cliente_anexos', '//192.168.125.16//Dados//SID//Cliente//Anexos', default, default);
