...
(default, 'mail_sid_cliente_anexos_sucesso', 17, 4, 4, 1, default, default),
(default, 'mail_sid_cliente_anexos_falha', 18, 4, 4, 1, default, default),
(default, 'mail_sid_cliente_anexos_erro', 19, 4, 3, 1, default, default),
(default, 'mail_simpliss_piracicaba_sucesso', 27, 4, 5, 1, default, default),
(default, 'mail_simpliss_piracicaba_falha', 28, 4, 5, 1, default, default),
(default, 'mail_simpliss_piracicaba_erro', 29, 4, 3, 1, default, default);

INSERT INTO db_fluxosmail values
(default, 'mail_simpliss_piracicaba_sucesso', 17, 4, 4, 1, default, default),
(default, 'mail_simpliss_piracicaba_falha', 18, 4, 4, 1, default, default),
(default, 'mail_simpliss_piracicaba_erro', 19, 4, 4, 1, default, default);
